			...
			<div id="joinArea">
				...
				<div class="joinRow">
					<input type="text" id="uId" name="uId" maxlength="15"
						onkeyup="idChk(this.form)">
						<input type="hidden" id="uIdChk">
				...
				<div class="joinRow">
					<input type="password" name="uPw" maxlength="16" onkeyup="pwChk(this.form)">
				</div>
				...
				<div class="joinRow">
					<input type="password" id="uPwChk" name="uPwChk" maxlength="16" onkeyup="pwChk(this.form)">
				...
				<div class="joinRow">
					<input type="text" id="uName" name="uName" onkeyup="nameChk(this.form)">
				</div>
				...
				<div class="joinRow">
					<input type="text" id="uBirthday" maxlength="8" name="uBirthday" onkeyup="birthChk(this.form)"
				...
				<div class="joinRow">
					<input type="text" id="addr2" name="addr2" onkeyup="addr(this.form)">
				</div>
				...
				<div class="joinRow">
					<input type="hidden" id ="TermsAds" name="TermsAds" value="<%=getParam(request, "TermsAds")%>">
				</div>
